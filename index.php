  ...
  <div class="main_content">
    ...
    <div class="col-sm-6 col-lg-offset-3">    
        <p>Coding HTML emails that look good in all the major email clients is hard and time consuming. Blurbb is a drag-and-drop email builder that makes it easy to build beautiful cross-client emails without ever having to touch code.</p>
