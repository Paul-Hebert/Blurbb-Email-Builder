<?php
                echo '<div class="alignment" data_target="' . $include_data . '"><i class="fa fa-align-left selected"></i> <i class="fa fa-align-center"></i> <i class="fa fa-align-right"></i> <i class="fa fa-align-justify"></i></div>';
